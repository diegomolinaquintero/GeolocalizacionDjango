...
class EncontrarUbicacion6(APIView):
        ...
        def get(self, request):
                ...
                pronosticopronostico = requests.get('https://siata.gov.co/data/siata_app/wrfmedCentro.json')
                ...
                Barbosa = ['Barbosa']
                Girardota = ['Girardota']
                pronostico = pronosticopronostico
                #Palmitas
                ...
                datos = {
                    'ubicacion': MunicipioSinEspacios,
